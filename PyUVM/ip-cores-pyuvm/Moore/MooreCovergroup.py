...
class MooreCovergroup():
    ...
    def __init__(self):
        ...
        #self.cp2 = coverpoint(self.previous_state, bins={
            #"ps_000" : bin(0), "ps_001" : bin(1), "ps_010" : bin(2), "ps_011" : bin(3), "ps_100" : bin(4)
            #})
        #self.cp3 = coverpoint(self.current_state, bins={
            #"cs_000" : bin(0), "cs_001" : bin(1), "cs_010" : bin(2), "cs_011" : bin(3), "cs_100" : bin(4)
            #})
